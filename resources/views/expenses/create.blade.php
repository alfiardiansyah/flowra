    ...
    <x-card class="max-w-3xl mx-auto">
        <form action="{{ route('expenses.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            ...
            <div class="form-section">
                <label class="form-section-title">
                    <x-icon name="flower" class="w-5 h-5" />
                    Bukti Pembayaran / Struk (Opsional)
                </label>
                <div class="border-2 border-dashed border-sage-300 rounded-xl p-6 text-center hover:border-sage-400 transition-colors">
                    ...
                    <label for="bukti_pembayaran" class="cursor-pointer">
                        <x-icon name="falling-leaves" class="w-10 h-10 text-coral-400 mx-auto mb-2" />
                        <p class="text-xs text-earth-600 mb-1">Klik untuk upload foto struk atau bukti bayar</p>
